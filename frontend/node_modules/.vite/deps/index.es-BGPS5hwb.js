import { a as __toESM, n as __esmMin, t as __commonJSMin } from "./rolldown-runtime-FZ4Itg2g.js";
import { b as init_typeof, y as _typeof$1 } from "./jspdf.es.min-DXNA7bS8.js";
...
var call$2, uncurryThis$7, fixRegExpWellKnownSymbolLogic$2, anObject$3, isObject$2, toLength$4, toString$5, requireObjectCoercible$5, getMethod$2, advanceStringIndex$2, getRegExpFlags$3, regExpExec$2, stringIndexOf$3;
var init_es_string_match = __esmMin((() => {
	call$2 = require_function_call();
	uncurryThis$7 = require_function_uncurry_this();
	fixRegExpWellKnownSymbolLogic$2 = require_fix_regexp_well_known_symbol_logic();
	anObject$3 = require_an_object();
	isObject$2 = require_is_object();
	toLength$4 = require_to_length();
	toString$5 = require_to_string();
	requireObjectCoercible$5 = require_require_object_coercible();
	getMethod$2 = require_get_method();
	advanceStringIndex$2 = require_advance_string_index();
	getRegExpFlags$3 = require_regexp_get_flags();
	regExpExec$2 = require_regexp_exec_abstract();
	stringIndexOf$3 = uncurryThis$7("".indexOf);
...
var apply, call$1, uncurryThis$6, fixRegExpWellKnownSymbolLogic$1, fails$2, anObject$2, isCallable, isObject$1, toIntegerOrInfinity, toLength$3, toString$4, requireObjectCoercible$4, advanceStringIndex$1, getMethod$1, getSubstitution, getRegExpFlags$2, regExpExec$1, REPLACE, max, min$3, concat, push$1, stringIndexOf$2, stringSlice$2, maybeToString, REPLACE_KEEPS_$0, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE;
var init_es_string_replace = __esmMin((() => {
	apply = require_function_apply();
	call$1 = require_function_call();
	uncurryThis$6 = require_function_uncurry_this();
	fixRegExpWellKnownSymbolLogic$1 = require_fix_regexp_well_known_symbol_logic();
	fails$2 = require_fails();
	anObject$2 = require_an_object();
	isCallable = require_is_callable();
	isObject$1 = require_is_object();
	toIntegerOrInfinity = require_to_integer_or_infinity();
	toLength$3 = require_to_length();
	toString$4 = require_to_string();
	requireObjectCoercible$4 = require_require_object_coercible();
	advanceStringIndex$1 = require_advance_string_index();
	getMethod$1 = require_get_method();
	getSubstitution = require_get_substitution();
	getRegExpFlags$2 = require_regexp_get_flags();
	regExpExec$1 = require_regexp_exec_abstract();
	REPLACE = require_well_known_symbol()("replace");
	max = Math.max;
	min$3 = Math.min;
	concat = uncurryThis$6([].concat);
	push$1 = uncurryThis$6([].push);
	stringIndexOf$2 = uncurryThis$6("".indexOf);
	stringSlice$2 = uncurryThis$6("".slice);
...
var $$6, uncurryThis$5, getOwnPropertyDescriptor$1, toLength$2, toString$3, notARegExp$2, requireObjectCoercible$3, correctIsRegExpLogic$2, IS_PURE$1, stringSlice$1, min$2, CORRECT_IS_REGEXP_LOGIC$1;
var init_es_string_starts_with = __esmMin((() => {
	$$6 = require_export();
	uncurryThis$5 = require_function_uncurry_this_clause();
	getOwnPropertyDescriptor$1 = require_object_get_own_property_descriptor().f;
	toLength$2 = require_to_length();
	toString$3 = require_to_string();
	notARegExp$2 = require_not_a_regexp();
	requireObjectCoercible$3 = require_require_object_coercible();
	correctIsRegExpLogic$2 = require_correct_is_regexp_logic();
	IS_PURE$1 = require_is_pure();
	stringSlice$1 = uncurryThis$5("".slice);
	min$2 = Math.min;
...
var globalThis$1, DOMIterables, DOMTokenListPrototype, ArrayIteratorMethods, createNonEnumerableProperty, setToStringTag, ITERATOR, ArrayValues, handlePrototype;
var init_web_dom_collections_iterator = __esmMin((() => {
	globalThis$1 = require_global_this();
...
var $$5, $reduce, arrayMethodIsStrict$1, CHROME_VERSION;
var init_es_array_reduce = __esmMin((() => {
	$$5 = require_export();
	$reduce = require_array_reduce().left;
	arrayMethodIsStrict$1 = require_array_method_is_strict();
...
var $$4, uncurryThis$4, getOwnPropertyDescriptor, toLength$1, toString$2, notARegExp$1, requireObjectCoercible$2, correctIsRegExpLogic$1, IS_PURE, slice, min$1, CORRECT_IS_REGEXP_LOGIC;
var init_es_string_ends_with = __esmMin((() => {
	$$4 = require_export();
	uncurryThis$4 = require_function_uncurry_this_clause();
	getOwnPropertyDescriptor = require_object_get_own_property_descriptor().f;
	toLength$1 = require_to_length();
	toString$2 = require_to_string();
	notARegExp$1 = require_not_a_regexp();
	requireObjectCoercible$2 = require_require_object_coercible();
	correctIsRegExpLogic$1 = require_correct_is_regexp_logic();
	IS_PURE = require_is_pure();
	slice = uncurryThis$4("".slice);
	min$1 = Math.min;
	CORRECT_IS_REGEXP_LOGIC = correctIsRegExpLogic$1("endsWith");
	$$4({
		target: "String",
		proto: true,
...
var call, uncurryThis$3, fixRegExpWellKnownSymbolLogic, anObject$1, isObject, requireObjectCoercible$1, speciesConstructor, advanceStringIndex, toLength, toString$1, getMethod, getRegExpFlags$1, regExpExec, stickyHelpers, fails$1, UNSUPPORTED_Y, MAX_UINT32, min, push, stringSlice, stringIndexOf$1, SPLIT_WORKS_WITH_OVERWRITTEN_EXEC, BUGGY;
var init_es_string_split = __esmMin((() => {
	call = require_function_call();
	uncurryThis$3 = require_function_uncurry_this();
	fixRegExpWellKnownSymbolLogic = require_fix_regexp_well_known_symbol_logic();
	anObject$1 = require_an_object();
	isObject = require_is_object();
	requireObjectCoercible$1 = require_require_object_coercible();
	speciesConstructor = require_species_constructor();
	advanceStringIndex = require_advance_string_index();
	toLength = require_to_length();
	toString$1 = require_to_string();
	getMethod = require_get_method();
	getRegExpFlags$1 = require_regexp_get_flags();
	regExpExec = require_regexp_exec_abstract();
	stickyHelpers = require_regexp_sticky_helpers();
	fails$1 = require_fails();
	UNSUPPORTED_Y = stickyHelpers.UNSUPPORTED_Y;
	MAX_UINT32 = 4294967295;
	min = Math.min;
	push = uncurryThis$3([].push);
	stringSlice = uncurryThis$3("".slice);
	stringIndexOf$1 = uncurryThis$3("".indexOf);
	SPLIT_WORKS_WITH_OVERWRITTEN_EXEC = !fails$1(function() {
		var re = /(?:)/;
...
var $$3, $trim;
var init_es_string_trim = __esmMin((() => {
	$$3 = require_export();
...
var $$2, uncurryThis$2, $indexOf, arrayMethodIsStrict, nativeIndexOf, NEGATIVE_ZERO;
var init_es_array_index_of = __esmMin((() => {
	$$2 = require_export();
	uncurryThis$2 = require_function_uncurry_this_clause();
	$indexOf = require_array_includes().indexOf;
	arrayMethodIsStrict = require_array_method_is_strict();
	nativeIndexOf = uncurryThis$2([].indexOf);
...
var $$1, uncurryThis$1, notARegExp, requireObjectCoercible, toString, correctIsRegExpLogic, stringIndexOf;
var init_es_string_includes = __esmMin((() => {
	$$1 = require_export();
	uncurryThis$1 = require_function_uncurry_this();
...
var $, uncurryThis, isArray, nativeReverse, test;
var init_es_array_reverse = __esmMin((() => {
	$ = require_export();
...
var init_SVGPathData_module = __esmMin((() => {
	t = function(r, e) {
...
var init_es_regexp_to_string = __esmMin((() => {
...
__esmMin((() => {
	...
	import_raf = /* @__PURE__ */ __toESM(require_raf());
	init_es_string_trim();
	import_rgbcolor = /* @__PURE__ */ __toESM(require_rgbcolor());
