import { i as __toCommonJS, t as __commonJSMin } from "./rolldown-runtime-FZ4Itg2g.js";
import { f as init_jspdf_es_min, m as jspdf_es_min_exports } from "./jspdf.es.min-DXNA7bS8.js";
//#region node_modules/jspdf-autotable/dist/jspdf.plugin.autotable.js
var require_jspdf_plugin_autotable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	* 
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function() {
			...
			var __webpack_modules__ = {
				172: (function(__unused_webpack_module, exports$1) {
					...
					exports$1.CellHookData = exports$1.HookData = void 0;
					...
					exports$1.HookData = HookData;
					exports$1.CellHookData = function(_super) {
				...
				340: (function(__unused_webpack_module, exports$2, __webpack_require__) {
					...
					function default_1(jsPDF) {
						...
						*/
						jsPDF.API.autoTableEndPosY = function() {
							...
							if (prev && prev.finalY) return prev.finalY;
							else return 0;
						};
						/**
						* @deprecated
						*/
						jsPDF.API.autoTableAddPageContent = function(hook) {
							...
							if (!jsPDF.API.autoTable.globalDefaults) jsPDF.API.autoTable.globalDefaults = {};
				...
				136: (function(__unused_webpack_module, exports$3) {
					...
					*/
					...
					exports$3["default"] = default_1;
				}),
				420: (function(__unused_webpack_module, exports$4) {
					Object.defineProperty(exports$4, "__esModule", { value: true });
					exports$4.getPageAvailableWidth = exports$4.parseSpacing = exports$4.getFillStyle = exports$4.addTableBorder = exports$4.getStringWidth = void 0;
					...
					exports$4.getStringWidth = getStringWidth;
					...
					exports$4.addTableBorder = addTableBorder;
					...
					exports$4.getFillStyle = getFillStyle;
					...
					exports$4.parseSpacing = parseSpacing;
					function getPageAvailableWidth(doc, table) {
						var margins = parseSpacing(table.settings.margin, 0);
						return doc.pageSize().width - (margins.left + margins.right);
					}
					exports$4.getPageAvailableWidth = getPageAvailableWidth;
				}),
				796: (function(__unused_webpack_module, exports$5) {
					var __extends = this && this.__extends || (function() {
						var extendStatics = function(d, b) {
							extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
								d.__proto__ = b;
					...
					exports$5.getTheme = exports$5.defaultStyles = exports$5.HtmlRowInput = void 0;
					exports$5.HtmlRowInput = function(_super) {
					...
					exports$5.defaultStyles = defaultStyles;
					...
					exports$5.getTheme = getTheme;
				}),
				903: (function(__unused_webpack_module, exports$6, __webpack_require__) {
					Object.defineProperty(exports$6, "__esModule", { value: true });
					exports$6.parseCss = void 0;
				...
				744: (function(__unused_webpack_module, exports$7) {
					Object.defineProperty(exports$7, "__esModule", { value: true });
					exports$7.DocHandler = void 0;
					var globalDefaults = {};
					exports$7.DocHandler = function() {
				...
				4: (function(__unused_webpack_module, exports$8, __webpack_require__) {
					Object.defineProperty(exports$8, "__esModule", { value: true });
					exports$8.parseHtml = void 0;
					...
					function parseRowContent(supportedFonts, scaleFactor, window, row, includeHidden, useCss) {
						...
						for (var i = 0; i < row.cells.length; i++) {
							...
							if (includeHidden || style_1.display !== "none") {
								...
								if (useCss) cellStyles = (0, cssParser_1.parseCss)(supportedFonts, cell, scaleFactor, style_1, window);
								resultRow.push({
				...
				776: (function(__unused_webpack_module, exports$9, __webpack_require__) {
					Object.defineProperty(exports$9, "__esModule", { value: true });
					exports$9.parseInput = void 0;
					var htmlParser_1 = __webpack_require__(4);
					...
					exports$9.parseInput = parseInput;
				...
				792: (function(__unused_webpack_module, exports$10) {
						...
						var _loop_1 = function(options) {
							...
							if (!options.didDrawPage && (options.afterPageContent || options.beforePageContent || options.afterPageAdd)) {
								...
								options.didDrawPage = function(data) {
									...
									doc.applyStyles(doc.userStyles);
									if (options.afterPageAdd && data.pageNumber > 1) data.afterPageAdd(data);
									doc.applyStyles(doc.userStyles);
								};
							}
							[
								...
								if (options[name]) console.error("The \"".concat(name, "\" hook has changed in version 3.0, check the changelog for how to migrate."));
							});
							[
								["showFoot", "showFooter"],
								["showHead", "showHeader"],
							...
							[
								...
								if (typeof options[deprecatedOption] !== "undefined") {
									if (typeof options.styles[style] === "undefined") options.styles[style] = options[deprecatedOption];
					...
					exports$10["default"] = default_1;
					function checkStyles(styles) {
						if (styles.rowHeight) {
							console.error("Use of deprecated style rowHeight. It is renamed to minCellHeight.");
							if (!styles.minCellHeight) styles.minCellHeight = styles.rowHeight;
						} else if (styles.columnWidth) {
							console.error("Use of deprecated style columnWidth. It is renamed to cellWidth.");
							if (!styles.cellWidth) styles.cellWidth = styles.columnWidth;
						}
					}
				}),
				260: (function(__unused_webpack_module, exports$11, __webpack_require__) {
					Object.defineProperty(exports$11, "__esModule", { value: true });
					exports$11.Column = exports$11.Cell = exports$11.Row = exports$11.Table = void 0;
					var config_1 = __webpack_require__(796);
					var HookData_1 = __webpack_require__(172);
					var common_1 = __webpack_require__(420);
					exports$11.Table = function() {
						...
						Table.prototype.callCellHooks = function(doc, handlers, cell, row, column, cursor) {
							for (var _i = 0, handlers_1 = handlers; _i < handlers_1.length; _i++) {
								...
								var result = handler(new HookData_1.CellHookData(doc, this, cell, row, column, cursor)) === false;
				...
				356: (function(__unused_webpack_module, exports$12) {
					Object.defineProperty(exports$12, "__esModule", { value: true });
					exports$12.assign = void 0;
					...
					exports$12.assign = assign;
				}),
				972: (function(__unused_webpack_module, exports$13, __webpack_require__) {
					Object.defineProperty(exports$13, "__esModule", { value: true });
					exports$13.createTable = void 0;
					var documentHandler_1 = __webpack_require__(744);
					...
					exports$13.createTable = createTable;
					...
					function getSectionTitle(section, column) {
						if (section === "head") {
							if (typeof column === "object") return column.header || column.title || null;
					...
					function createColumns(columns) {
						return columns.map(function(input, index) {
							var _a, _b;
							var key;
							if (typeof input === "object") key = (_b = (_a = input.dataKey) !== null && _a !== void 0 ? _a : input.key) !== null && _b !== void 0 ? _b : index;
							else key = index;
				...
				664: (function(__unused_webpack_module, exports$14, __webpack_require__) {
					Object.defineProperty(exports$14, "__esModule", { value: true });
					exports$14.addPage = exports$14.drawTable = void 0;
					var common_1 = __webpack_require__(420);
					var models_1 = __webpack_require__(260);
					var documentHandler_1 = __webpack_require__(744);
					var polyfills_1 = __webpack_require__(356);
					...
					exports$14.drawTable = drawTable;
				...
				224: (function(__unused_webpack_module, exports$15, __webpack_require__) {
					Object.defineProperty(exports$15, "__esModule", { value: true });
					exports$15.calculateAllColumnsCanFitInPage = void 0;
					var common_1 = __webpack_require__(420);
					...
					exports$15.calculateAllColumnsCanFitInPage = calculateAllColumnsCanFitInPage;
				}),
				324: (function(__unused_webpack_module, exports$16, __webpack_require__) {
					Object.defineProperty(exports$16, "__esModule", { value: true });
					exports$16.ellipsize = exports$16.resizeColumns = exports$16.calculateWidths = void 0;
					var common_1 = __webpack_require__(420);
					/**
					...
					*/
					...
					exports$16.calculateWidths = calculateWidths;
					function calculate(doc, table) {
						...
						table.allRows().forEach(function(row) {
							for (var _i = 0, _a = table.columns; _i < _a.length; _i++) {
								...
								cell.minReadableWidth = (0, common_1.getStringWidth)(cell.text.join(" ").split(/[^\S\u00A0]+/), cell.styles, doc) + cell.padding("horizontal");
					...
					*/
					...
					exports$16.resizeColumns = resizeColumns;
					...
					exports$16.ellipsize = ellipsize;
					function ellipsizeStr(text, width, styles, doc, overflow) {
						var precision = 1e4 * doc.scaleFactor();
						width = Math.ceil(width * precision) / precision;
						if (width >= (0, common_1.getStringWidth)(text, styles, doc)) return text;
				...
				964: (function(module$1) {
					if (typeof __WEBPACK_EXTERNAL_MODULE__964__ === "undefined") {
						var e = /* @__PURE__ */ new Error("Cannot find module 'undefined'");
						e.code = "MODULE_NOT_FOUND";
						throw e;
					}
					module$1.exports = __WEBPACK_EXTERNAL_MODULE__964__;
				})
			};
			...
			(function() {
				var exports$17 = __webpack_exports__;
				Object.defineProperty(exports$17, "__esModule", { value: true });
				exports$17.Cell = exports$17.Column = exports$17.Row = exports$17.Table = exports$17.CellHookData = exports$17.__drawTable = exports$17.__createTable = exports$17.applyPlugin = void 0;
				var applyPlugin_1 = __webpack_require__(340);
				var inputParser_1 = __webpack_require__(776);
				var tableDrawer_1 = __webpack_require__(664);
				var tableCalculator_1 = __webpack_require__(972);
				var models_1 = __webpack_require__(260);
				Object.defineProperty(exports$17, "Table", {
					enumerable: true,
					get: function() {
				...
				var HookData_1 = __webpack_require__(172);
				Object.defineProperty(exports$17, "CellHookData", {
					enumerable: true,
					get: function() {
				...
				Object.defineProperty(exports$17, "Cell", {
					enumerable: true,
					get: function() {
						return models_2.Cell;
					}
				});
				Object.defineProperty(exports$17, "Column", {
					enumerable: true,
					get: function() {
						return models_2.Column;
					}
				});
				Object.defineProperty(exports$17, "Row", {
					enumerable: true,
					get: function() {
						return models_2.Row;
					}
				...
				exports$17.applyPlugin = applyPlugin;
				...
				exports$17.__createTable = __createTable;
				function __drawTable(d, table) {
					(0, tableDrawer_1.drawTable)(d, table);
				}
				exports$17.__drawTable = __drawTable;
				try {
					var jsPDF = __webpack_require__(964);
					if (jsPDF.jsPDF) jsPDF = jsPDF.jsPDF;
					applyPlugin(jsPDF);
				} catch (error) {}
				exports$17["default"] = autoTable;
			})();
